...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvAppStorage.pas 12562 2009-10-19 22:11:08Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/tags/JVCL3_39/run/JvAppStorage.pas $';
    Revision: '$Revision: 12562 $';
    Date: '$Date: 2009-10-20 00:11:08 +0200 (mar., 20 oct. 2009) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
