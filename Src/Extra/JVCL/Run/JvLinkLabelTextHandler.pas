...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/tags/JVCL3_39/run/JvLinkLabelTextHandler.pas $';
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        // We're only Ìnterested in the first word; let's break if there are more
